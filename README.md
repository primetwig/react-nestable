...
| renderCollapseIcon | function | `() => <DefaultIcon />` | Function for rendering collapse icon. Has a single parameter with keys: `item` - item from your array, `isCollapsed` - boolean, true if this group has children and is collapsed. |
