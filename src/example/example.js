    ...
    renderExampleTwo = () => {
        return (
            <div>
                ...
                <Nestable items={items} renderItem={this.renderItem} handler={<span style={handlerStyles} />} />
            </div>
        );
    };
    ...
    renderExampleThree = () => {
        return (
            <div>
                ...
                <Nestable items={grocery} renderItem={this.renderItem} confirmChange={this.confirmChange} />
            </div>
        );
    };
